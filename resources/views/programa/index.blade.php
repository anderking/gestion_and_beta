...
<div class="col-sm-offset-5 col-sm-7 col-md-offset-4 col-md-8 col-lg-offset-3 col-lg-9 main main_solicitud_create">
	...
	@if(count($solicitud_programa)>0)
		...
		<ul class="list-group">
			...
			<li class="list-group-item"><b>Usuario: </b> {{ $solicitud_programa->user->name }}</li>
			<li class="list-group-item"><b>Carrera: </b> {{ $solicitud_programa->carrera->nombre }}</li>
			<li class="list-group-item"><b>Pensum: </b> {{ $solicitud_programa->pensum->nombre }}</li>
			<li class="list-group-item"><b>Total: </b> {{ $solicitud_programa->precio_fact }} Bs.S</li>
			...
			@if($solicitud_programa->status=='R' || $solicitud_programa->status=='A')
			...
			@if(Auth::user()->hasRole('directoradm'))
				@if($solicitud_programa->status=='R')
				<li class="list-group-item">
					<a href="#modal-aprobar-solicitud_programa-{{ $solicitud_programa->id }}" data-toggle="modal" class="btn btn-info">Aprobar</a>
				</li>
				@endif
			@endif
